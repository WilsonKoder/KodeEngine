...
KodeEngine::Mesh::Mesh(Vertex* vertices, GLuint numVertices)
{
    ...
    glBufferData(GL_ARRAY_BUFFER, numVertices * sizeof(vertices[0]), positions.data(), GL_STATIC_DRAW);
	...
	glBufferData(GL_ARRAY_BUFFER, numVertices * sizeof(texCoords[0]), texCoords.data(), GL_STATIC_DRAW);
